/* ===[PROJECT MOTION PATCHED]=== *//* ===[PROJECT MOTION PATCHED]=== *//* ===[PROJECT MOTION PATCHED]=== *//* ===[PROJECT MOTION PATCHED]=== *//* ===[PROJECT MOTION PATCHED]=== *//* ===[PROJECT MOTION PATCHED]=== *//* ===[PROJECT MOTION PATCHED]=== *//* ===[PROJECT MOTION PATCHED]=== *//* ===[PROJECT MOTION PATCHED]=== *//* ===[PROJECT MOTION PATCHED]=== *//* ===[PROJECT MOTION PATCHED]=== *//* ===[PROJECT MOTION PATCHED]=== *//* ===[PROJECT MOTION PATCHED]=== *//* ===[PROJECT MOTION PATCHED]=== *//* ===[PROJECT MOTION PATCHED]=== *//* ===[PROJECT MOTION PATCHED]=== *//* ===[PROJECT MOTION PATCHED]=== *//* ===[PROJECT MOTION PATCHED]=== *//* ===[PROJECT MOTION PATCHED]=== */declare module BABYLON {
